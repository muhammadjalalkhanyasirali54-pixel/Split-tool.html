...
Save the supplied index(1).html file as index.html.

Open index.html in your browser.

Select a PDF containing two or four labels per page.

Choose the rotation and output order. For two labels, also choose the split direction.

Click Split 2 Labels → 4 x 6 or Split 4 Labels → 4 x 6.

Open the downloaded PDF and check the labels before printing.
...
Complete application: layout, styling, and PDF processing
